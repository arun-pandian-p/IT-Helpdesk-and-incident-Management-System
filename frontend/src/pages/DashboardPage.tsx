...
import { dashboardService, ticketService, assetService } from '../services/api';
import { DashboardSummary, Ticket, Asset } from '../types';
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <Link
            to="/tickets/new"
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-lg shadow-xs transition"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <h3 className="text-xs font-bold text-slate-900">Submit Ticket</h3>
            <p className="text-[11px] text-slate-500 mt-1">
              Get help with laptop, Wi-Fi, VPN, Outlook, or software issues.
            </p>
          </Link>
          ...
          >
            ...
            <h3 className="text-xs font-bold text-slate-900">Request Access / MFA</h3>
            <p className="text-[11px] text-slate-500 mt-1">
              Request shared drives, reset Authenticator, or app permissions.
            </p>
          </Link>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">
            IT Service Desk Operational Dashboard
          </h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Real-time incident queues, SLA compliance targets, and operational analytics
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
        ...
        <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
          ...
          <span className="text-[10px] text-slate-400">Awaiting assignment</span>
        </div>
